class User < ApplicationRecord
  ...
  has_many :f_followers, class_name: 'Follow', foreign_key: "following_id", dependent: :destroy
  has_many :f_following, class_name: 'Follow', foreign_key: "follower_id", dependent: :destroy
